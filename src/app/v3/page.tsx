				...
				<div className="container flex justify-between items-center max-md:flex-col max-md:gap-8">
					<div className="flex flex-col items-start gap-8">
						<Title className="max-w-[650px]" level={1} size="5xl">
							<span className="text-secondary">СРОЧНАЯ НОВОСТЬ ДЛЯ МАМ{' '}</span>
							<span>Запишите своего ребенка на путь будущего!</span>
						</Title>
						<Text>
							Бесплатный мастер-класс по искусственному интеллекту для детей 6-14 лет в Армавире уже в эти выходные!💻
						</Text>
						<ContactUsButton>
